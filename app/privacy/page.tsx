    ...
    <>
      ...
      <main>
        <article className="legal-page">
          ...
          <p>The website form sends the details you enter to our sales team through FormSubmit. FormSubmit processes the submission for us and may retain it for up to 30 days under its own privacy terms.</p>
          <h2>Privacy</h2>
